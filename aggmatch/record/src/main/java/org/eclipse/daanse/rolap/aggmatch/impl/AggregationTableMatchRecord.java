...
public record AggregationTableMatchRecord(String id, AggregationCharacterCase charCase, String prefixRegex,
        String suffixRegex, String nameExtractRegex) implements AggregationTableMatch {
