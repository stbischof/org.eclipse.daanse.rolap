...
public record AggregationMatchRuleRecord(String tag, Boolean enabled, AggregationTableMatch tableMatch,
        AggregationFactCountMatch factCountMatch, AggregationForeignKeyMatch foreignKeyMatch,
        AggregationLevelMap levelMap, AggregationMeasureMap measureMap, AggregationIgnoreMap ignoreMap)
    ...
    @Override
    public AggregationTableMatch getTableMatch() {
        return tableMatch;
    }

    @Override
    public AggregationFactCountMatch getFactCountMatch() {
        return factCountMatch;
    }

    @Override
    public AggregationForeignKeyMatch getForeignKeyMatch() {
        return foreignKeyMatch;
    }

    @Override
    public AggregationLevelMap getLevelMap() {
        return levelMap;
    }

    @Override
    public AggregationMeasureMap getMeasureMap() {
        return measureMap;
    }

    @Override
    public Optional<AggregationIgnoreMap> getIgnoreMap() {
        return Optional.ofNullable(ignoreMap);
    }
}
