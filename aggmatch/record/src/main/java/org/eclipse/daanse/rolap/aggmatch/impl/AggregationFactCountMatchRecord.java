...
public record AggregationFactCountMatchRecord(String id, AggregationCharacterCase charCase, String prefixRegex,
        String suffixRegex, String nameExtractRegex, String factCountName) implements AggregationFactCountMatch {
    ...
    @Override
    public Optional<String> getFactCountName() {
        return Optional.ofNullable(factCountName);
    }
}
