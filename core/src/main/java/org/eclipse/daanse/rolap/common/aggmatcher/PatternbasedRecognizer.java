 ...
 */
class PatternbasedRecognizer extends Recognizer {

    private final PatternbasedRules aggDefault;
    ...
    PatternbasedRecognizer(
        final PatternbasedRules aggDefault,
    ...
    /**
     * Get the PatternbasedRules instance associated with this object.
     */
    PatternbasedRules getRules() {
        return aggDefault;
    }
	...
	protected int checkMeasures() {
        msgRecorder.pushContextName("PatternbasedRecognizer.checkMeasures");
    ...
    {
        msgRecorder.pushContextName("PatternbasedRecognizer.matchLevel");
        try {
