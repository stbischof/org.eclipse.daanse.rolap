...
public record AggregationMeasureMapRecord(
    String id,
    List<AggregationMatchRegex> regexes
) implements AggregationMeasureMap {

    public AggregationMeasureMapRecord {
        regexes = regexes != null ? List.copyOf(regexes) : List.of();
    }

    @Override public String getId() { return id; }
    @Override public List<AggregationMatchRegex> getRegexes() { return regexes; }
}
