...
public record AggregationMatchRegexRecord(
    String id,
    AggregationCharacterCase charCase,
    String template,
    String space,
    String dot
) implements AggregationMatchRegex {
    ...
    @Override public Optional<String> getSpace() { return Optional.ofNullable(space); }
    @Override public Optional<String> getDot() { return Optional.ofNullable(dot); }
}
